  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="card-elevated-lg p-8">
        ...
        <FormSection icon="👤" title="Homeowner Information" quote='"Let&apos;s start by getting your names so everything is personalized for you."'>
        ...
        <FormSection icon="🏠" title="Project Details" quote='"Based on our inspection, here&apos;s what we&apos;re recommending for your home."'>
        ...
        <FormSection icon="📋" title="System Options & Pricing" quote='"We put together three options so you can choose what fits best. Option A is our top-of-the-line, B is our most popular, and C is our value package."'>
        ...
        <FormSection icon="⚡" title="Value & Energy Analysis" quote='"Now let&apos;s look at what this does for you long-term. This isn&apos;t just a cost — it&apos;s an investment that pays you back."' className="">
