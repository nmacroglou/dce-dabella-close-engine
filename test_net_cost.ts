...
const computed: ComputedValues = {
  options: {
    A: { price: 18000, monthly: 162, efficiencyPrice: 19000, standbyPrice: 20000, deferred6Price: 18000, deferred12Price: 18000, monthlyEfficiency: 171, monthlyStandby: 180, monthlyDeferred6: 162, monthlyDeferred12: 162, roiValue: 14000, netCost: 18000 - 14000 - 7200 },
    B: { price: 13500, monthly: 122, efficiencyPrice: 14250, standbyPrice: 15000, deferred6Price: 13500, deferred12Price: 13500, monthlyEfficiency: 129, monthlyStandby: 135, monthlyDeferred6: 122, monthlyDeferred12: 122, roiValue: 10500, netCost: 13500 - 10500 - 7200 },
    C: { price: 9000, monthly: 81, efficiencyPrice: 9500, standbyPrice: 10000, deferred6Price: 9000, deferred12Price: 9000, monthlyEfficiency: 86, monthlyStandby: 90, monthlyDeferred6: 81, monthlyDeferred12: 81, roiValue: 7000, netCost: 9000 - 7000 - 7200 },
  },
  annualCost: 2400,
  tenYearCost: 24000,
  energySavings: 7200,
...
async function main() {
  ...
  require("fs").writeFileSync("/tmp/test-net-cost.pdf", buffer);
